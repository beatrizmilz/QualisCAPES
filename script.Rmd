...
Renomear as colunas
```{r}
qualis_2010_2012 <- qualis_2010_2012 %>% rename(issn = ISSN, titulo = `Título`, area_de_avaliacao = `Área de Avaliação`, estrato = Estrato)

qualis_2013_2016 <- qualis_2013_2016 %>% rename(issn = ISSN, titulo = `Título`, area_de_avaliacao = `Área de Avaliação`, estrato = Estrato)
```
