...
```{r message=FALSE, warning=FALSE}
#qualis_2010_2012 <- readr::read_delim("data/capes/classificacoes_2010-2012.xls", 
#    "\t", escape_double = FALSE, locale = locale(encoding = "ISO-8859-1"), 
#    trim_ws = TRUE)


qualis_2013_2016 <- readr::read_delim("data/capes/classificacoes_2013-2016.xls", 
    "\t", escape_double = FALSE, locale = locale(encoding = "ISO-8859-1"), 
    trim_ws = TRUE)
...
```{r}
qualis_capes <- dplyr::bind_rows(
  #qualis_2010_2012,
  qualis_2013_2016)
```

```{r}
qualis_capes$estrato <- as.factor(qualis_capes$estrato)
```
